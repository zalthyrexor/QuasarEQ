...
namespace config {
  ...
  struct PIdx {
    enum { Freq, Q, Gain, Bypass, Type, Chan, SR};
  };

  inline const std::array<juce::String, 6> biquadPrefixes {ID_FREQ, ID_Q, ID_GAIN, ID_BYPASS, ID_FILTER_SHAPE, ID_CHANNEL_MODE};
  inline const std::array<juce::String, 5> butterPrefixes {ID_FREQ, ID_ORDER, ID_BYPASS, ID_BUTTER_SHAPE, ID_CHANNEL_MODE};
